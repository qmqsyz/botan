   ...
   switch(key_len) {
      case 1632:
         return ffi_guard_thunk(__func__, [=]() -> int {
            ...
            auto kyber512 = std::make_unique<Botan::Kyber_PrivateKey>(privkey_vec, Botan::KyberMode::Kyber512_Round3);
      ...
      case 2400:
         return ffi_guard_thunk(__func__, [=]() -> int {
            ...
            auto kyber768 = std::make_unique<Botan::Kyber_PrivateKey>(privkey_vec, Botan::KyberMode::Kyber768_Round3);
      ...
      case 3168:
         return ffi_guard_thunk(__func__, [=]() -> int {
            ...
            auto kyber1024 = std::make_unique<Botan::Kyber_PrivateKey>(privkey_vec, Botan::KyberMode::Kyber1024_Round3);
   ...
   switch(key_len) {
      case 800:
         return ffi_guard_thunk(__func__, [=]() -> int {
            ...
            auto kyber512 = std::make_unique<Botan::Kyber_PublicKey>(pubkey_vec, Botan::KyberMode::Kyber512_Round3);
      ...
      case 1184:
         return ffi_guard_thunk(__func__, [=]() -> int {
            ...
            auto kyber768 = std::make_unique<Botan::Kyber_PublicKey>(pubkey_vec, Botan::KyberMode::Kyber768_Round3);
      ...
      case 1568:
         return ffi_guard_thunk(__func__, [=]() -> int {
            ...
            auto kyber1024 = std::make_unique<Botan::Kyber_PublicKey>(pubkey_vec, Botan::KyberMode::Kyber1024_Round3);
