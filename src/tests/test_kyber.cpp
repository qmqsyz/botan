...
class KYBER_Tests final : public Test {
   public:
      ...
      std::vector<Test::Result> run() override {
         ...
         results.push_back(run_kyber_test("Kyber512 API", Botan::KyberMode::Kyber512_Round3, 128));
         results.push_back(run_kyber_test("Kyber768 API", Botan::KyberMode::Kyber768_Round3, 192));
         results.push_back(run_kyber_test("Kyber1024 API", Botan::KyberMode::Kyber1024_Round3, 256));
   #endif
